...
class MainFrame(wx.Frame):
    ...
    def init_ui(self):
        ...
        self.task_list.AppendTextColumn("Task / Subtask", width=400)
    ...
    def on_add_subtask(self, event):
        ...
        # Update parent duration to include subtasks?
        # Standard logic: if subtasks exist, parent duration = sum(subtasks)
        # But for simplicity here we just append.
        # Optionally: parent_task.duration += st.duration
