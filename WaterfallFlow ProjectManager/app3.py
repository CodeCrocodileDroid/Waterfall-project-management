...
class MainFrame(wx.Frame):
    ...
    def init_ui(self):
        ...
        self.task_list.SetBackgroundColour(wx.Colour(40, 40, 40))  # Slightly lighter than main bg
        ...
        # Title Input
        self.txt_title = wx.TextCtrl(self.controls_panel, value="", size=(250, -1), style=wx.BORDER_SIMPLE)
        ...
        # Duration Input
        self.spin_dur = wx.SpinCtrl(self.controls_panel, value="1", min=1, max=365, size=(70, -1),
                                    style=wx.BORDER_SIMPLE)
        self.spin_dur.SetBackgroundColour(self.col_input_bg)
        self.spin_dur.SetForegroundColour(self.col_fg_text)

        # Assignee Input
        self.txt_assignee = wx.TextCtrl(self.controls_panel, value="", size=(150, -1), style=wx.BORDER_SIMPLE)
        ...
        controls_sizer.Add(self.txt_title, 1, wx.ALIGN_CENTER_VERTICAL | wx.LEFT, 8)

        controls_sizer.Add(make_lbl("Days:"), 0, wx.ALIGN_CENTER_VERTICAL | wx.LEFT, 15)
        controls_sizer.Add(self.spin_dur, 0, wx.ALIGN_CENTER_VERTICAL | wx.LEFT, 8)

        controls_sizer.Add(make_lbl("Who:"), 0, wx.ALIGN_CENTER_VERTICAL | wx.LEFT, 15)
        controls_sizer.Add(self.txt_assignee, 0, wx.ALIGN_CENTER_VERTICAL | wx.LEFT, 8)

        controls_sizer.Add(self.btn_add_task, 0, wx.ALIGN_CENTER_VERTICAL | wx.LEFT, 20)
        controls_sizer.Add(self.btn_add_sub, 0, wx.ALIGN_CENTER_VERTICAL | wx.LEFT | wx.RIGHT, 10)
    ...
    def on_list_selection(self, event):
        ...
        if row != wx.NOT_FOUND and row in self.row_map:
            ...
            if item['type'] == 'task':
                ...
                self.btn_add_sub.SetLabel(f"+ Subtask to '{item['obj'].title[:10]}...'")
            else:
                self.btn_add_sub.Disable()
